...
vec3f::vec3f(vec3r::rc v) : vec3f(float(v._0), float(v._1), float(v._2)) {}
...
vec3r::vec3r(vec3f::rc v) : vec3r(qreal(v._0), qreal(v._1), qreal(v._2)) {}
...
mat3r::mat3r(qreal _00_, qreal _01_, qreal _02_, qreal _10_, qreal _11_,
             qreal _12_, qreal _20_, qreal _21_, qreal _22_) {
  _00 = _00_;
  _01 = _01_;
  _02 = _02_;
  _10 = _10_;
...
bool mat3r::operator==(mat3r::rc n) const {
  return _00 == n._00 && _01 == n._01 && _02 == n._02 && _10 == n._10 &&
         _11 == n._11 && _12 == n._12 && _20 == n._20 && _21 == n._21 &&
         _22 == n._22;
}
...
mat3r mat3r::operator*(mat3r::rc n) const {
  return mat3r(_00 * n._00 + _01 * n._10 + _02 * n._20,
...
vec3r mat3r::operator*(vec3r::rc v) const {
  return vec3r(_00 * v._0 + _01 * v._1 + _02 * v._2,
