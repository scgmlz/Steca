...
class QcrDialog : protected QcrModal, QcrSettable, public QDialog  { // (inheritance order matters!)
public:
...
class QcrFileDialog : protected QcrModal, QcrSettable, public QFileDialog  {
public:
    QcrFileDialog(
