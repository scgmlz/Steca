...
#define LMBC_DIF_DUMMY_CLASS LM_ADD_PREFIX(lmbc_dif_dummy_class)
...
int ret;
  ...
  LMBC_DIF_DUMMY_CLASS dummyObj;
  DelegateCalculation function(&dummyObj, &LMBC_DIF_DUMMY_CLASS::LMBC_DIF_FUNC);
  DelegateCalculation functionJacobian(&dummyObj, &LMBC_DIF_DUMMY_CLASS::LMBC_DIF_JACF);
  ret=LEVMAR_BC_DER(&function, &functionJacobian, p, x, m, n, lb, ub, dscl, itmax, opts, info, work, covar, (void *)&data);
