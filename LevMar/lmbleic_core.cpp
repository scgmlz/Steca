...
#define LMBLEIC_DUMMY_CLASS LM_ADD_PREFIX(lmbleic_dummy_class)
...
public:
	...
	void LMBLEIC_JACF(LM_REAL *pext, LM_REAL *jacext, int mm, int n, void *adata)
	{
	struct LMBLEIC_DATA *data=(struct LMBLEIC_DATA *)adata;
	int m;
	register int i, j;
                      ...
                      */
{
  ...
  LMBLEIC_DUMMY_CLASS dummyObj;
  DelegateCalculation function(&dummyObj, &LMBLEIC_DUMMY_CLASS::LMBLEIC_FUNC);
  DelegateCalculation functionJacobian(&dummyObj, &LMBLEIC_DUMMY_CLASS::LMBLEIC_JACF);
  ret=LEVMAR_BLEC_DER(&function, &functionJacobian, pext, x, mm, n, lbext, ubext, Aext, bext, k12, NULL, itmax, opts, info, work, covext, (void *)&data);
                      ...
                      */
{
  ...
  LMBLEIC_DUMMY_CLASS dummyObj;
  DelegateCalculation function(&dummyObj, &LMBLEIC_DUMMY_CLASS::LMBLEIC_FUNC);
  ret=LEVMAR_BLEC_DIF(&function, pext, x, mm, n, lbext, ubext, Aext, bext, k12, NULL, itmax, opts, info, work, covext, (void *)&data);
