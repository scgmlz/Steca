...
class LensBase {
public:
  LensBase(core::Session const&, data::Datasets::rc, bool trans, bool cut,
...
class ImageLens final : public LensBase {
  CLASS(ImageLens)
  SUPER(LensBase) public : ImageLens(core::Session const&, typ::Image::rc,
...
class DatasetLens final : public LensBase {
  CLASS(DatasetLens)
  SUPER(LensBase) public
      : DatasetLens(core::Session const&, data::Dataset::rc, data::Datasets::rc,
                    eNorm, bool trans, bool cut, typ::ImageTransform::rc,
                    typ::ImageCut::rc);
