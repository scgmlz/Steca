...
#define LMLEC_DUMMY_CLASS LM_ADD_PREFIX(lmlec_dummy_class)
...
class LMLEC_DUMMY_CLASS
{
public:
	/* constrained measurements: given pp, compute the measurements at c + Z*pp */
	void LMLEC_FUNC(LM_REAL *pp, LM_REAL *hx, int mm, int n, void *adata)
	{
	 ...
	 */
	void LMLEC_JACF(LM_REAL *pp, LM_REAL *jacjac, int mm, int n, void *adata)
	{
	struct LMLEC_DATA *data=(struct LMLEC_DATA *)adata;
	int m;
	register int i, j, l;
                      ...
                      */
{
  ...
  LMLEC_DUMMY_CLASS dummyObj;
  DelegateCalculation function(&dummyObj, &LMLEC_DUMMY_CLASS::LMLEC_FUNC);
  DelegateCalculation functionJacobian(&dummyObj, &LMLEC_DUMMY_CLASS::LMLEC_JACF);
  ret=LEVMAR_DER(&function, &functionJacobian, pp, x, mm, n, itmax, opts, info, work, NULL, (void *)&data);
                      ...
                      */
{
  ...
  LMLEC_DUMMY_CLASS dummyObj;
  DelegateCalculation function(&dummyObj, &LMLEC_DUMMY_CLASS::LMLEC_FUNC);
  ret=LEVMAR_DIF(&function, pp, x, mm, n, itmax, opts, info, work, NULL, (void *)&data);
