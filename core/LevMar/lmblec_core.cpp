...
#define LMBLEC_DUMMY_CLASS LM_ADD_PREFIX(lmblec_dummy_class)
...
class LMBLEC_DUMMY_CLASS
{
public:
	/* augmented measurements */
	void LMBLEC_FUNC(LM_REAL *p, LM_REAL *hx, int m, int n, void *adata)
	{
	...
	/* augmented Jacobian */
	void LMBLEC_JACF(LM_REAL *p, LM_REAL *jac, int m, int n, void *adata)
	{
	struct LMBLEC_DATA *data=(struct LMBLEC_DATA *)adata;
	int nn, *typ;
	register int i, j;
                      ...
                      */
{
  ...
  LMBLEC_DUMMY_CLASS dummyObj;
  DelegateCalculation function(&dummyObj, &LMBLEC_DUMMY_CLASS::LMBLEC_FUNC);
  DelegateCalculation functionJacobian(&dummyObj, &LMBLEC_DUMMY_CLASS::LMBLEC_JACF);
  ret=LEVMAR_LEC_DER(&function, &functionJacobian, p, data.x, m, n+m, A, b, k, itmax, opts, info, work, covar, (void *)&data);
                      ...
                      */
{
  ...
  LMBLEC_DUMMY_CLASS dummyObj;
  DelegateCalculation function(&dummyObj, &LMBLEC_DUMMY_CLASS::LMBLEC_FUNC);
  ret=LEVMAR_LEC_DIF(&function, p, data.x, m, n+m, A, b, k, itmax, opts, info, work, covar, (void *)&data);
