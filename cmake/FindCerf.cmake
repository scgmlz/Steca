...
#   - Cerf_LIBRARY      .. full path to library
...
find_library(Cerf_LIBRARY NAMES cerf Cerf)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(Cerf DEFAULT_MSG Cerf_LIBRARY Cerf_INCLUDE_DIR)

if(NOT Cerf_FOUND)
    unset(Cerf_FOUND)
    unset(Cerf_LIBRARY)
    find_library(Cerf_LIBRARY NAMES cerfcpp)
    find_package_handle_standard_args(Cerf DEFAULT_MSG Cerf_LIBRARY Cerf_INCLUDE_DIR)
    if(NOT Cerf_FOUND)
        ...
        set(Cerf_IS_CPP ON PARENT_SCOPE)
    endif()
else()
   message(STATUS "Found libcerf")
   set(Cerf_IS_CPP OFF PARENT_SCOPE)
endif()
