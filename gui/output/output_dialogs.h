...
class Params : public QWidget, protected RefHub {
  CLASS(Params)
  SUPER(QWidget) public : enum ePanels {
    REFLECTION    = 0x01,
    GAMMA         = 0x02,
    POINTS        = 0x04,
    INTERPOLATION = 0x08,
...
class Table : public TreeView, protected RefHub {
  ...
  void setColumns(str_lst::rc headers, str_lst::rc outHeaders,
                  typ::cmp_vec::rc);
...
class TabTable : public Tab {
  CLASS(TabTable)
  SUPER(Tab) public : TabTable(TheHub &, Params &, str_lst::rc headers,
                               str_lst::rc outHeaders, typ::cmp_vec::rc);
